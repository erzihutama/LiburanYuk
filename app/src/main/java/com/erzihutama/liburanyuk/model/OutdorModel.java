...
public class OutdorModel implements Parcelable {
    ...
    protected OutdorModel(Parcel in) {
    ...
    public static final Creator<OutdorModel> CREATOR = new Creator<OutdorModel>() {
        @Override
        public OutdorModel createFromParcel(Parcel in) {
            return new OutdorModel(in);
        }

        @Override
        public OutdorModel[] newArray(int size) {
            return new OutdorModel[size];
        }
    };
